# ============================================================
# QIS Dashboard - 自动上传至百炼知识库定时任务设置脚本
# ============================================================
# 功能: 创建 Windows 定时任务,每日 18:00 自动上传 general reports 至百炼
...
Write-Host "  QIS Dashboard - 设置上传百炼定时任务" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""

# 配置参数
$TaskName = "QIS_Upload_To_Bailian"
$TaskDescription = "每日 18:00 自动上传 general reports 至阿里云百炼知识库"
$ScriptPath = "D:\QIS_DASHBOARD\ali_bailian\upload_daily.bat"
$TriggerTime = "18:00"
$LogFile = "D:\QIS_DASHBOARD\logs\upload_daily.log"
...
try {
    ...
    Write-Host "  3. 查看日志: Get-Content D:\QIS_DASHBOARD\logs\upload_daily.log -Tail 50" -ForegroundColor White
    Write-Host ""
...
Write-Host "  - 查看日志: Get-Content D:\QIS_DASHBOARD\logs\upload_daily.log -Tail 50" -ForegroundColor White
Write-Host ""
